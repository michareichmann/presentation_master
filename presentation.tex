...
\newcommand{\z}{\text}
\newcommand{\terminal}[1]{\colorbox{black}{\textcolor{white}{{\fontfamily{phv}\selectfont #1}}}}
\usepackage{pgfpages}
...
% new frame =========================================
\begin{frame}
	\frametitle{Fixing the delays}
	\begin{itemize}
		\item expected signal for single ROC without Token Bit Manager (TBM)
	\end{itemize}
	\begin{figure}
		\includegraphics[height=2.5cm]{Pics/levels}
		\caption{example level scheme for pixel 5 12 }
	\end{figure}
	\begin{itemize}
		\item example output of the CLI: 
		\begin{itemize}
